...
client.on("message", async(kmsg)=>{
    ...
    switch (cmd) {
        ...
        case 'zajil':
            ...
            if(attatch){
                kmsg.react(`👍`).catch((E)=> {});
                (await client.channels.fetch(zajil_data.channel)).send(`<@${(await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).id}`,new MessageEmbed({ author: { name: (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).displayName, iconURL: (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).user.avatar ? (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).user.avatarURL({ dynamic: true }) : `https://cdn.discordapp.com/embed/avatars/0.png` }, description: args.slice(1).join(` `), title: `**وصلك زاجل**`, thumbnail: {url: (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).avatar ? (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).user.avatarURL({ dynamic: true }) : `https://cdn.discordapp.com/embed/avatars/0.png` }, image: { url: attatch.url }}));
                ...
                kmsg.react(`👍`).catch((E)=> {});
                (await client.channels.fetch(zajil_data.channel)).send(`<@${(await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).id}`,new MessageEmbed({ author: { name: (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).displayName, iconURL: (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).user.avatar ? (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).user.avatarURL({ dynamic: true }) : `https://cdn.discordapp.com/embed/avatars/0.png` }, description: args.slice(1).join(` `), title: `**وصلك زاجل**`, thumbnail: {url: (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).user.avatar ? (await client.guilds.fetch(zajil_data.guild)).members.cache.get(args[0]).user.avatarURL({ dynamic: true }) : `https://cdn.discordapp.com/embed/avatars/0.png` }}));
